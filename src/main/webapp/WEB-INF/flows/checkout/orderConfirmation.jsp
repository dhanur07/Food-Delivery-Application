                        ...
                        <div class="row">
                            <table class="table table-hover">
                                ...
                                <c:forEach var="cartItem" items="${order.cart.cartItems}" >
                                    <tr>
                                        <th scope="row" class="col-md-9"><em>${cartItem.product.productName}</em></th>
                                        <th scope="row" class="col-md-1" style="text-align: center">${cartItem.quantity}</th>
                                        <th scope="row" class="col-md-1" style="text-align: center">${cartItem.product.productPrice}</th>
                                        <th scope="row" class="col-md-1" style="text-align: center">${cartItem.totalPrice}</th>
                                    </tr>
                                </c:forEach>
